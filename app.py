...
def depreciation_series(brand, mdl, base_year, km, fuel, transmission, seller_type, owner):
    years, prices = [], []
    for yr in range(base_year, 2026):
    ...
    with col_result:
        if predict_btn:
            ...
            <div style="text-align:center; padding:80px 20px; color:#334155;">
              ...
              <div style="font-size:16px; margin-top:12px;">Fill in the details and click<br><b style="color:#38bdf8;">Predict Price</b></div>
            </div>
            """, unsafe_allow_html=True)
